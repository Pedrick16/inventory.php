...
<a href="../add-products-admin/add-deluxe.php">Add Products</a>
<table>
        <thead>
        <tr>
            <th>Product code </th>
        ...
        <tr>
            ...
            <td><button><a href="../add-inventory-admin/add-stock-deluxe.php?PRODUCT-CODE=<?php echo $row['product_code'];?>" id="add">Add Stock</a></button></td>
        </tr>
