    ...
    <h1>EDIT CLASSIC</h1>
        ...
        if(isset($_POST['submit'])){
            ...
            if($price == $E_price And $status == $E_status And $available_stock == $E_avail_stock){
                ...
                $sql = "UPDATE special SET price ='$price', available_stock=' $available_stock', status='$status' WHERE product_code ='$product_code'";
                $con->query($sql) or die ($con->error);
                echo header("Location: ../product-list-admin/special.php");       
            }
        }
