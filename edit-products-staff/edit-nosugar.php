...
$sql = "SELECT * FROM no_sugar WHERE product_code='$product_code' ";
...
<body>
    ...
    <h1>EDIT CLASSIC</h1>
        ...
        <a href="../staff-site/nosugar.php">Back</a>
        <br>    
        ...
        if(isset($_POST['submit'])){
            ...
            if($price == $E_price And $status == $E_status And $available_stock == $E_avail_stock){
                ...
                $sql = "UPDATE no_sugar SET price ='$price', available_stock=' $available_stock', status='$status' WHERE product_code ='$product_code'";
                $con->query($sql) or die ($con->error);
                echo header("Location: ../staff-site/nosuagr.php");       
            }
        }
